# ALL MP3 FILES USED MUST HAVE A TITLE IN THEIR PROPERTIES SECTION
...
keylabel.grid(row=1,column=5, padx=2, pady=2, sticky="nsew")
...
titlelabel.grid(row=1,column=1, padx=2, pady=2, sticky="nsew")
...
unpauselabel.grid(row=1,column=4, padx=2, pady=2, sticky="nsew")
...
def darkmode():
    ...
    try:
        if colour=='white':
            ...
            button10.config(bg='black', fg='white')
            button11.config(bg='black', fg='white')
            button12.config(bg='black', fg='white')
            unpauselabel.config(bg='black', fg='white')
            titlelabel.config(bg='black', fg='white')
            exit.config(bg='black', fg='white')
            keylabel.config(bg='black', fg='white')
            frame.config(bg='black')
            tslider.config(bg='black', fg='white')
        elif colour=='black':
            colour='white'
            tk.config(bg='white')
            ...
            unpauselabel.config(bg='white', fg='black')
            titlelabel.config(bg='white', fg='black')
            exit.config(bg='white', fg='black')
            keylabel.config(bg='white', fg='black')
            frame.config(bg='white')
            tslider.config(bg='white', fg='black')
...
keyboard.add_hotkey(key9, darkmode)
